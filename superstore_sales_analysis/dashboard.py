...
if fl is not None:
    ...
    os.chdir(r"C:\Users\tanwa\Downloads\superstore_sales_analysis\superstore_sales_analysis")
...
with cl1:
    with st.expander("Category_ViewData"):
        st.write(category_df.style.background_gradient(cmap="Blues").to_html(), unsafe_allow_html=True)
...
with cl2:
    with st.expander("Region_ViewData"):
        ...
        st.write(region.style.background_gradient(cmap="Oranges").to_html(), unsafe_allow_html=True)
...
with st.expander("View Data of TimeSeries:"):
    st.write(linechart.T.style.background_gradient(cmap="Blues").to_html(), unsafe_allow_html=True)
...
with st.expander("Summary_Table"):
    ...
    st.write(sub_category_Year.style.background_gradient(cmap="Blues").to_html(), unsafe_allow_html=True)
...
with st.expander("View Data"):
    st.write(filtered_df.iloc[:500, 1:20:2].style.background_gradient(cmap="Oranges").to_html(), unsafe_allow_html=True)
